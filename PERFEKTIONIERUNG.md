...
- **S0.1 — Test-Netz Suite-Kern.** Node-Headless-Selbsttest (`test/selftest-node.js` im Root) für die pure Rechenlogik: Geld/Datum-Helfer, BKP-Katalog, Kostensummen, Nachträge, Zahlungsplan-Rechnung, Gantt-Datumslogik. **DoD:** `node test/selftest-node.js` grün, deckt die 15–20 kritischsten Funktionen ab.
