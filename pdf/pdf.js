...
function sectionCutOpening(out, X, Yh, distPt, appW, o, H, perPt, wall, flip, noDims, mullion, revealOnly) {   // revealOnly = nur Laibung/Schichteinzug zeichnen (Rahmen/Glas/Bank kommen aus Solids)
  ...
  if (layered) {   // Wand-Backing in der Laibung (Sturz oben + Schwelle unten): Wandschichten laufen bündig bis zum Rahmen → keine weisse Lücke, Schraffur durchgehend; Lining + Rahmen/Glas zeichnen darüber
